...
import 'package:movies_tv/about.dart';
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(onPressed: ()=>Navigator.of(context).push(MaterialPageRoute(builder: (context)=>About())), icon: Icon(FontAwesomeIcons.userDoctor,color: Colors.red,))
          ],
        ),
